...
> Ex:- /setspell Check Your Spelling {query}
"""
...
● all the pin related commands can be found here; keep your chat up to date on the latest news with a simple pinned message!🔋 **--Commands and Usage**-- :
